...
This year also marks the biggest point gap I've ever experienced of all CTF - a whopping 4k points. Everything looks so unrealistic, maybe I'm really in an Isekai world? That explains perhaps. We promise we're not intentionally creating it, really.
...
```
After running the script, we get the following flag: `w.my{2ba914045b56c5e58..1b4a593b05746}`. Some characters are intentionally masked.
